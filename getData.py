...
print(requestURL)
response = urllib.request.urlopen(requestURL, context=ssl._create_unverified_context(), data=urllib.request.parse.urlencode({"startDate":"2020-01-01T03:00:00","endDate":"2020-04-01T03:00:00"}).encode())
