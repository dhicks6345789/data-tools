...
columnPos = {"Name":0,"Username":70,"Year":100,"Login":None,"Classroom":None,"Login/Class":115,"Activity, %":140}
			...
			for activityIndex, activityValues in activity.iterrows():
				...
				if not username == "":
					...
					if lastActivity == "Never":
						...
						report.at[indexToUse, "Activity, %"] = round(1 - intToConstrainedPercentage(lastActivity, 3, 8), 2)
