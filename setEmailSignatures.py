...
for staffIndex, staff in staff.iterrows():
  ...
  if staff["Username"] == "d.hicks":
    print("gam user " + staff["Username"] + "@knightsbridgeschool.com signature config/emailSignature.html replyto " + staff["Username"] + "@knightsbridgeschool.com (replace name " + staff["GivenName"] + " " + staff["FamilyName"] + ")")
